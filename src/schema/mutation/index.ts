...
/**
 * Build mutation object type
 *
 * @param pubsub PubSub
 * @returns GraphQLObjectType
 */
const mutation = (pubsub: PubSub) =>
  new GraphQLObjectType({
    name: 'Mutation',
    fields: {
      addApiConfiguration,
      addApplication: addApplication(pubsub),
      addChannel,
      addDashboard,
      addForm,
      addGroup,
      ...
      addPullJob,
      addRecord: addRecord(pubsub),
      generateRecords: generateRecords(pubsub),
      addReferenceData,
      addRole,
      addRoleToUsers,
      addStep,
      addSubscription,
      addTemplate,
      addUsers: addUsers(pubsub),
      addWorkflow,
      convertRecord,
      deleteApiConfiguration,
      deleteApplication: deleteApplication(pubsub),
      deleteChannel,
      deleteDashboard,
      deleteForm,
      deleteGroup,
      ...
      editApplication: editApplication(pubsub),
      editChannel,
      editDashboard,
      editForm,
      editLayout,
      ...
      editStep,
      editSubscription,
      editUser: editUser(pubsub),
      editUserProfile,
      editWorkflow,
      fetchGroups,
      editTemplate,
      publish,
      publishNotification: publishNotification(pubsub),
      restoreRecord,
      seeNotification,
      seeNotifications,
      toggleApplicationLock: toggleApplicationLock(pubsub),
      addAggregation,
      editAggregation,
      deleteAggregation,
      addDistributionList,
      ...
      addCustomNotification: addCustomNotification(pubsub),
      editCustomNotification: editCustomNotification(pubsub),
